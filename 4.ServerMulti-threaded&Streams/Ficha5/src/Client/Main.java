...
public class Main extends javax.swing.JFrame {
    ...
    private void JloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JloginActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "IP inválido", "Alert", JOptionPane.WARNING_MESSAGE);
        }
        try {
            socket = new Socket(ip, Integer.parseInt(port));
            client = new Client(textarea, socket);
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(this, "Socket inválida", "Alert", JOptionPane.WARNING_MESSAGE);
        }
        ...
        try {
            ...
            } else if(client.login(name,socket)==false) {
                JOptionPane.showMessageDialog(this, "Nome de utilizador já existe", "Alert", JOptionPane.WARNING_MESSAGE);
            } else {
    ...
    private void JsendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JsendActionPerformed
        message = this.Jmessage.getText();
        client.enviar(name, message, socket);
